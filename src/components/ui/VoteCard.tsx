...
const VoteCard: React.FC<VoteCardProps> = ({
  ...
  const getCardStyles = () => {
    const baseStyles = "border rounded-lg p-4 transition-all duration-200 ease-in-out";
    const hoverStyles = !disabled ? "hover:shadow-md cursor-pointer" : "opacity-75 cursor-not-allowed";
  ...
  return (
    ...
    >
      <div className="flex items-start space-x-4">
        <div className={`${getIconStyles()} mt-1`}>
          {getIcon()}
        </div>
        <div>
